...
class SingleAgentEnv(gym.Env):
    ...
    def __draw_info(self):
        ...
        obs_text = self.font4.render(
            f"Obs: {self.observation}",
            True,
            self.INFO_TEXT_COLOR2,
        )
        reward_text = self.font4.render(
        ...
        self.info_screen.blit(obs_text, (self.INFO_MARGIN + 24, self.INFO_MARGIN + 140))
        self.info_screen.blit(
            reward_text, (self.INFO_MARGIN + 24, self.INFO_MARGIN + 170)
        )
